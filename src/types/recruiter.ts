...
export interface Recruiter {
  ...
  cv?: {
    ...
    experiences?: Array<{ company: string; title: string; start_date?: string; end_date?: string; location?: string; description?: string }>;
    formations?: Array<{ institution: string; degree: string; field?: string; start_date?: string; end_date?: string }>;
    source?: string;
    status?: string;
    skills?: string[];
    file_path?: string;
