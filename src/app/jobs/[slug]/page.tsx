...
export default function PublicJobPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#f5fae8]">
        <div className="flex flex-col items-center gap-4">
          ...
          />
          <p className="text-sm text-[#5c7d17] font-medium">Chargement de l'offre…</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#f5fae8]">
        <div className="text-center px-6">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Offre introuvable</h1>
          <p className="text-gray-500">Cette offre n'existe pas ou a expiré.</p>
        </div>
      </div>
    );
  }
  ...
  const infoItems = [
    ...
    offer.salary && { icon: "💰", label: "Salaire", value: offer.salary },
    offer.experience_required && { icon: "🎯", label: "Expérience", value: offer.experience_required },
    ...
    <div className="min-h-screen bg-gray-50">
              ...
              {!submitted ? (
                ...
                >
                  ...
                  <p className="text-gray-500 text-[15px] max-w-sm mx-auto leading-relaxed">
                    Merci pour votre candidature. Notre équipe RH vous recontactera dans les meilleurs délais.
                  </p>
                </motion.div>
              )}
            </motion.div>
      ...
      <footer className="border-t border-gray-100 bg-white mt-8">
        <div className="max-w-6xl mx-auto px-6 py-6 flex items-center justify-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()}{clientName ? ` ${clientName}.` : "."} Tous droits réservés.</p>
        </div>
      </footer>
    </div>
  );
