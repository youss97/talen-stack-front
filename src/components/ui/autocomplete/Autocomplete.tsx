...
// Composants d'icônes basés sur lucide-react
const ChevronDownIcon = ({ className }: { className?: string }) => (
  <ChevronDown size={16} strokeWidth={1.8} className={`icon-glow ${className || ''}`} />
);

const XMarkIcon = ({ className }: { className?: string }) => (
  <X size={16} strokeWidth={1.8} className={`icon-glow ${className || ''}`} />
);

const LoadingIcon = ({ className }: { className?: string }) => (
  <Loader2 size={16} strokeWidth={1.8} className={`icon-glow animate-spin ${className || ''}`} />
);
