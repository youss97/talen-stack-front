...
const mockCandidates = [
  { value: '1', label: 'Jean Dupont', subtitle: 'Développeur Full Stack - TechCorp (REF-001)' },
  { value: '2', label: 'Marie Martin', subtitle: 'Designer UX/UI - DesignStudio (REF-002)' },
  { value: '3', label: 'Pierre Durand', subtitle: 'Chef de Projet - ProjectCorp (REF-003)' },
  { value: '4', label: 'Sophie Leroy', subtitle: 'Développeuse Frontend - WebAgency (REF-004)' },
  { value: '5', label: 'Thomas Bernard', subtitle: 'Analyste Business - ConsultFirm (REF-005)' },
];
        ...
        {selectedValue && (
          <div className="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
            ...
            <p className="text-xs text-green-600 dark:text-green-400 mt-1">
              {mockCandidates.find((c) => c.value === selectedValue)?.label} -{' '}
              {mockCandidates.find((c) => c.value === selectedValue)?.subtitle}
            </p>
          </div>
        )}
